...
global.owner = process.env.OWNER_NUMBER  || '6288214989352' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Asia/Jakarta' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "6288214989352" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"Ilham Gantenk,               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '25_05_2024_SIGMA_MD_uw7JqiDX_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'ZxynnBoTz-MD',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Ilhammmmm`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'ZxynnBoTz-MD',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "By Ilhammm" ,          // ADD YOUR STICKER PACKNAME
